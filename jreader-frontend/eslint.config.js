...
export default tseslint.config(
  ...
  { files: ['**/*.{ts,tsx}'], ...tseslint.configs.strictTypeChecked[0] },
  { files: ['**/*.{ts,tsx}'], ...tseslint.configs.stylisticTypeChecked[0] },
  ...
  // ---- Tests (TS parser, Jest globals, TS unused-vars with "_") ----
  {
    files: [
      '**/*.{test,spec}.{ts,tsx}',
      '**/__tests__/**',
